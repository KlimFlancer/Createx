    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                if (e.target.closest(".categoryes-main__close")) {
                    bodyUnlock();
        ...
        function initSliders() {
            if (document.querySelector(".hero-page")) new swiper_core_Swiper(".hero-page__slider", {
                ...
                navigation: {
                    prevEl: ".hero-page__arrows .arrow-hero_prev",
                    nextEl: ".hero-page__arrows .arrow-hero_next"
                },
                on: {}
            });
            if (document.querySelector(".slider-header")) new swiper_core_Swiper(".slider-header__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                simulateTouch: true,
                navigation: {
                    prevEl: ".arrows-header .arrow-header_prev",
                    nextEl: ".arrows-header .arrow-header_next"
                },
                on: {}
            });
            if (document.querySelector(".slider-arrivals")) new swiper_core_Swiper(".slider-arrivals__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            if (document.querySelector(".slider-trending")) new swiper_core_Swiper(".slider-trending__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                speed: 800,
                navigation: {
                    prevEl: ".arrows-trending .arrow-trending_prev",
                    nextEl: ".arrows-trending .arrow-trending_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-sale")) new swiper_core_Swiper(".slider-sale__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                nested: true,
                navigation: {
                    prevEl: ".arrows-sale .arrow-sale_prev",
                    nextEl: ".arrows-sale .arrow-sale_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".product-image-slider")) new swiper_core_Swiper(".product-image-slider__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".arrows-slider-image .arrow-slider-image_prev",
                    nextEl: ".arrows-slider-image .arrow-slider-image_next"
                },
                on: {}
            });
            if (document.querySelector(".images-general-card")) {
                const thumbsImages = new swiper_core_Swiper(".images-general-card__thumbs", {
                    modules: [],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                new swiper_core_Swiper(".images-general-card__slider", {
                    ...
                    navigation: {
                        prevEl: ".arrows-card .arrow-card_prev",
                        nextEl: ".arrows-card .arrow-card_next"
                    },
                    on: {}
                });
            }
            if (document.querySelector(".slider-look")) new swiper_core_Swiper(".slider-look__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".arrows-look .arrow-look_prev",
                    nextEl: ".arrows-look .arrow-look_next"
                },
                pagination: {
                    el: ".slider-look__dotts",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".slider-recently")) new swiper_core_Swiper(".slider-recently__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                speed: 800,
                navigation: {
                    prevEl: ".arrows-recently .arrow-recently_prev",
                    nextEl: ".arrows-recently .arrow-recently_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".search-main__icon")) document.querySelector(".search-main").classList.toggle("_show-search"); else if (!targetElement.closest(".search-main__form") && document.querySelector(".search-main._show-search")) document.querySelector(".search-main").classList.remove("_show-search");
            if (window.innerWidth > 767) if (targetElement.closest(".dropdown-categoryes-main__title")) {
                const activeElement = document.querySelector("._dropdown-show");
                if (activeElement && activeElement !== targetElement) activeElement.classList.remove("_dropdown-show");
                targetElement.closest(".dropdown-categoryes-main").classList.toggle("_dropdown-show");
            } else if (!targetElement.closest(".dropdown-categoryes-main__content") && document.querySelector(".dropdown-categoryes-main._dropdown-show")) {
                const dropdownArr = document.querySelectorAll(".dropdown-categoryes-main");
                dropdownArr.forEach((item => {
                    item.classList.remove("_dropdown-show");
                }));
            }
            if (targetElement.closest(".categoryes-main__button")) document.documentElement.classList.add("_show-menu"); else if (targetElement.closest(".categoryes-main__back")) document.documentElement.classList.remove("_show-menu");
            if (targetElement.closest(".filter-catalog__button") && window.innerWidth > 992) {
                targetElement.closest(".filter-catalog").classList.toggle("_show-catalog");
                targetElement.closest(".catalog__body").classList.toggle("_active");
            }
            if (targetElement.closest(".actions-main_cart")) {
                document.documentElement.classList.add("_show-carts");
                document.documentElement.classList.add("_carts-lock");
            } else if (targetElement.closest(".carts-header__close")) {
                document.documentElement.classList.remove("_show-carts");
                document.documentElement.classList.remove("_carts-lock");
            }
        }
        if (document.querySelector(".timer")) {
            const days = document.querySelector(".timer__days");
            const hourse = document.querySelector(".timer__hourse");
            const minutes = document.querySelector(".timer__minutes");
            const seconds = document.querySelector(".timer__seconds");
            (new Date).getMonth();
            (new Date).getDate();
            const nextDate = new Date(`Dec 31 2023 00:00:00`);
            function timeUpdate() {
                const currentTime = new Date;
                const diff = nextDate - currentTime;
                let daysLeft = Math.floor(diff / 1e3 / 60 / 60 / 24);
                let hourseLeft = Math.floor(diff / 1e3 / 60 / 60) % 24;
                ...
                hourse.innerHTML = hourseLeft < 10 ? "0" + hourseLeft : hourseLeft;
